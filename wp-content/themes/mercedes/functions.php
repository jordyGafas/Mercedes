...
if ( ! function_exists( 'mint_load' ) ) {
	function mint_load() {
		...
		add_theme_support( 'post-formats', array( 'gallery', 'image', 'link', 'video' ) ); // Post Formats
		add_image_size( 'img-xl', 2000 ); // xl size
		add_image_size( 'img-lg', 1600 ); // large size
		add_image_size( 'img-md', 1024 ); // medium size
		add_image_size( 'img-sm', 768 ); // small size
		add_image_size( 'img-xs', 480 ); // x-small size
		register_nav_menus( array(
			'legal' => 'Legal'
		));
		add_post_type_support( 'page', 'thumbnail' );
		add_post_type_support( 'post', 'page-attributes' ); // Post order
